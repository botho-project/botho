...
pub trait ParserWithBuildInfo: Parser {
    ...
    ///   `clap::Command`.
    fn command_with_build_info() -> clap::Command {
...
mod tests {
    ...
    fn version_on_clap_command() {
        ...
        let command = CommandWithVersion::command_with_build_info();
    ...
    fn no_version_on_clap_command() {
        ...
        let command = CommandWithoutVersion::command_with_build_info();
