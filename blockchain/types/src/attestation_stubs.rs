...
//! attestation is not used in Cadence's PoW consensus.
...
/// Stub for VerificationReport - attestation is not used in Cadence
...
/// Stub for VerificationSignature - attestation is not used in Cadence
#[derive(Clone, Deserialize, Digestible, Eq, Hash, PartialEq, Serialize, ::prost::Message)]
