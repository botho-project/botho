    ...
    bth_util_build_grpc_tonic::compile_protos_with_config(
        ...
        |builder| {
            builder
                ...
                .extern_path(".external", "::bth_api::external")
                .extern_path(".blockchain", "::bth_api::blockchain")
        },
    );
}
