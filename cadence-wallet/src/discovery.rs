...
/// DNS seed hostnames that resolve to active Cadence nodes
const DNS_SEEDS: &[&str] = &[
    "seed.cadence.network",
    "seed2.cadence.network",
    "seed.cadence-nodes.org",
];
...
/// Default RPC port for Cadence nodes
