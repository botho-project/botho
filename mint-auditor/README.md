...
```
$ ./target/docker/release/bt-mint-auditor \
      scan-ledger \
...
$ python3 integration_test.py \
    ...
    --mint-client-bin ../../target/docker/release/bt-consensus-mint-client \
...
```
    MC_LOG=bt_mint_auditor=debug cargo run -p bt-mint-auditor -- \
        scan-ledger \
