...
[`2e79acf2aee956dbc27903878c7dda74e4615213`](https://github.com/botho-project/botho/tree/2e79acf2aee956dbc27903878c7dda74e4615213)
...
tracks the candidate hybrid opening codec,
...
| Squads mint execution and recovery ([#1267](https://github.com/botho-project/botho/issues/1267)/[#1268](https://github.com/botho-project/botho/issues/1268)) | **Open integration evidence, not merged custody readiness.** [#1279](https://github.com/botho-project/botho/pull/1279) at [`c1f9529c`](https://github.com/botho-project/botho/commit/c1f9529c97af914a73bf405b591a239f3e8f355e) reports real pinned-program local CPI and 19 receipts. [#1300](https://github.com/botho-project/botho/pull/1300) at [`fa84a70a`](https://github.com/botho-project/botho/commit/fa84a70a49649523d2756301d400ba199b9834eb) reports durable engine/member-store execution and 13 finalized receipt logs. Its confirmed-deposit rows are fixtures, not a live BTH round trip. | Review/merge and validate the combined dependency base. Complete archived/late-member recovery [#1295](https://github.com/botho-project/botho/issues/1295), bounded retries and marker-rent funding [#1299](https://github.com/botho-project/botho/issues/1299). Retain backing on ambiguous/unsupported recovery. Then separately evidence authority configuration and both-chain operator drills; local CPI success does not authorize rotation or bridge value. |
