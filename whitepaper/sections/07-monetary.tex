...
\subsubsection{Fee Burning}

\textbf{All transaction fees are burned}, not paid to miners. This creates:

\begin{itemize}
  \item \textbf{Deflationary pressure}: High usage reduces supply
  \item \textbf{Anti-MEV}: No incentive to reorder transactions for fees
...
Under high utilization with progressive fees, burning may exceed tail
emission, creating net deflation.

\subsubsection{Fee Burning Analysis}

\begin{table}[h]
\centering
\caption{Fee burning scenarios (1M daily transactions)}
\label{tab:fee-burning}
\begin{tabular}{@{}lrr@{}}
\toprule
\textbf{Wealth Distribution} & \textbf{Daily Burn} & \textbf{Annual Burn} \\
\midrule
Equal (factor 1.0) & 16 BTH & 5,840 BTH \\
Current inequality & 48 BTH & 17,520 BTH \\
High inequality & 96 BTH & 35,040 BTH \\
\bottomrule
\end{tabular}
\end{table}
