...
Conservative parameters: 2.5\%/yr of supply routed from tail emission to
the lottery, 2\%/yr demurrage at factor 6, linear 6:1 payout tilt. Design
criterion: $\Delta G > 0.05$ versus the no-redistribution baseline.
Reproducible via \texttt{cluster-tax-sim lottery-experiment}.
