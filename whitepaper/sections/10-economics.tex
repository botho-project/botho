...
no-redistribution baseline. Runs are deterministic given an RNG seed;
the figures below use the default seed \texttt{2953379877} and are
reproducible via \texttt{cluster-tax-sim lottery-experiment} (a multi-seed
confidence interval is future work; see below).
...
combined mechanism reduces Gini by $\approx 0.08$ per five years in the
adversarial equilibrium ($0.77 \to 0.68$), passing the design criterion.
