...
\Botho uses the Ristretto255 group, a prime-order group
constructed from Curve25519. Ristretto eliminates cofactor-related
...
A Pedersen commitment to value $v$ with blinding factor
$r$ is:
\begin{equation}
C = vH + rG
\end{equation}
...
Bulletproofs provide zero-knowledge range proofs with
