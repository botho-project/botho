...
//! Convert to/from bth_transaction_extra::UnsignedTx.
...
mod tests {
    ...
    // bth_transaction_builder::UnsignedTx
    #[test]
    fn test_unsigned_tx_conversion() {
        ...
        for block_version in BlockVersion::iterator() {
            ...
            // Converting bth_transaction_builder::UnsignedTx -> external::UnsignedTx ->
            // bth_transaction_builder::UnsignedTx should be the identity function.
            {
