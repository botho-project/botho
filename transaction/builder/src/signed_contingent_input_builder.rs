...
use bth_transaction_extra::{SignedContingentInput, TxOutConfirmationNumber};
...
pub mod tests {
    ...
    #[test]
    fn test_signed_contingent_input_builder_basic() {
        ...
        for block_version in 3..=*BlockVersion::MAX {
            ...
            // Build a signed contingent input
            ...
            // tx_out_global_indices should match the ring global indices we provided
            assert!(!sci.tx_out_global_indices.is_empty());
        }
    }
}
