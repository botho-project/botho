...
impl TxSummaryStreamingVerifierCtx {
    ...
    pub fn digest_output(
        ...
        // this is an SCI
            ...
            let generator = bth_crypto_ring_signature::generators(token_id);
    ...
    fn view_key_match(&self, tx_out_summary: &TxOutSummary) -> Result<Option<Amount>, Error> {
        let tx_out_shared_secret = bth_crypto_ring_signature::get_tx_out_shared_secret(
...
mod tests {
    ...
    use bth_transaction_core::{tx::TxOut, BlockVersion};
