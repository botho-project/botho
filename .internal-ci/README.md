...
These build, dockerfiles, helm charts and scripts are used internally for Botho builds and deployments and is subject to change without notice, YMMV, no warranties provided, all that good stuff.
