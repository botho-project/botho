...
pub struct CorrectEncryptedSenderMemoData {
    ...
    pub sender_public_address_hex_proto_bytes: String,
    ...
    pub recipient_view_public_key_hex_raw_bytes: String,

    /// The encrypted sender memo bytes encoded as hex.
    pub encrypted_sender_memo_hex_raw_bytes: String,
}
...
pub struct IncorrectEncryptedSenderMemoData {
    /// A public address's proto bytes encoded as hex. This address did not
    /// write the sender memo.
    pub incorrect_sender_public_address_hex_proto_bytes: String,

    /// A view public key's bytes encoded as hex. This key is not the key that
    /// received the transaction with the sender memo.
    pub incorrect_recipient_view_public_key_hex_raw_bytes: String,
...
pub struct CorrectEncryptedDestinationMemoData {
    /// The transaction sender's public address proto bytes encoded as hex. This
    /// user wrote the destination memo.
    pub sender_public_address_hex_proto_bytes: String,

    /// The transaction recipient's short address hash raw bytes encoded as hex.
    /// This user received the TxOut that this destination memo describes.
    pub recipient_short_address_hash_hex_raw_bytes: String,
    ...
    /// The encrypted destination memo raw bytes encoded as hex.
    pub encrypted_destination_memo_hex_raw_bytes: String,
}
...
pub struct IncorrectEncryptedDestinationMemoData {
    /// A public address's proto bytes encoded as hex. This address did not
    /// write the destination memo.
    pub incorrect_sender_public_address_hex_proto_bytes: String,

    /// A short address hash's raw bytes encoded as hex. This short address hash
    /// does not correspond to the address that received the TxOut that the
    /// destination memo describes.
    pub incorrect_recipient_short_address_hash_hex_raw_bytes: String,
...
pub struct CorrectEncryptedSenderWithPaymentRequestIdMemoData {
    /// The transaction sender's public address proto bytes encoded as hex. This
    /// user wrote the sender with payment request ID memo.
    pub sender_public_address_hex_proto_bytes: String,
    ...
    /// The encrypted sender memo raw bytes encoded as hex.
    pub encrypted_sender_with_payment_request_id_memo_hex_raw_bytes: String,
}
...
pub struct IncorrectEncryptedSenderWithPaymentRequestIdMemoData {
    ...
    /// A view public key's raw bytes encoded as hex. This key is not the key
    /// that received the transaction with the sender with payment request ID
    /// memo.
    pub incorrect_recipient_view_public_key_hex_raw_bytes: String,
    ...
    /// The encrypted sender with payment request ID memo raw bytes encoded as
    /// hex.
    pub encrypted_sender_with_payment_request_id_memo_hex_raw_bytes: String,
}
